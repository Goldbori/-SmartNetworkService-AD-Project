...
👥 팀원 정보 (Team Members)
이름	학번	담당
선현승	20203080	진단 핸들러, 네트워크 그림판, SFC(Ryu), 윈도우 환경에서 테스트, 발표 대본 작성
김아리	20223056	진단 핸들러, 서버-클라이언트 소켓 통신, 우분투 환경에서 테스트, 보고서 정리
...
서버 시작/종료, 접속 클라이언트 목록, 서버 로그 등을 표시.

📸 스크린샷

(예: ./images/server_tab.png)
