...
## 🟩 2. Client 탭
클라이언트 연결/종료, 모드별 메시지 송신

### 2-1. 클라이언트 연결
📸 스크린샷  
![다중 클라이언트 접속](다중%20클라이언트%20접속.png)

### 2-2. 모드별 메시지 전송
📸 스크린샷  
![모드별 메세지 전송](모드별%20메세지%20전송.png)

### 2-3. 전송 후 종료
📸 스크린샷  
![전송 후 종료](전송%20후%20종료.png)
...
### 4-1. 브로드캐스트 ON
![브로드캐스트 on](브로드캐스트%20on.png)

### 4-2. 브로드캐스트 OFF
📸 스크린샷  
![브로드캐스트 off](브로드캐스트%20off.png)
